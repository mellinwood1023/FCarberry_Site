    ...
    <div className="about-container">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        <div className="w-75% md:w-80 flex-shrink-0 flex flex-row gap-4 justify-center items-start flex-wrap mb-4 md:flex-col md:gap-4 md:items-start md:mt-10">
          <img src="/images/kingston_house.webp" alt="kingston_house" className="rounded-lg shadow-md w-30 sm:w-28 md:w-full object-cover transition-all duration-300" />
          <img src="/images/chester_house.webp" alt="chester_house" className="rounded-lg shadow-md w-30 sm:w-28 md:w-full object-cover transition-all duration-300" />
          <img src="/images/fremont_house.webp" alt="Fremont_house" className="rounded-lg shadow-md w-35 sm:w-28 md:w-full object-cover transition-all duration-300" />
          {/* Add more <img> tags here for additional photos */}
          {/* <img src="/images/another_photo.jpg" alt="Description" className="rounded-lg shadow-md w-full object-cover" /> */}
        </div>
