...
const Services: React.FC = () => {
  ...
  return (
    <div className="about-container">
      ...
      <h1 className="text-3xl font-bold text-blue-900 mb-6 text-center pt-20 pb-5">
        Services
      </h1>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="w-full md:w-80 flex-shrink-0 mb-4 md:mt-10">

          <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide md:flex-col md:overflow-visible">

            <img
              src="/images/kingston_house.webp"
              alt="Kingston House"
              className="flex-shrink-0 w-[85vw] md:w-full rounded-lg shadow-md object-cover snap-center transition-all duration-300"
            />
